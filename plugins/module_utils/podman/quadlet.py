...
from ansible_collections.containers.podman.plugins.module_utils.podman.common import check_quadlet_directory
...
def create_quadlet_state(module, issuer):
    check_quadlet_directory(module)
    class_map = {
    ...
    quadlet_file_path = module.params.get('quadlet_file_path')
